...
// TV_Custom
  ...
  AddContainerWithCodecs("service/webos-broadcast", webos_codecs);
  AddContainerWithCodecs("service/webos-broadcast-cable", webos_codecs);
  AddContainerWithCodecs("service/webos-camera", webos_codecs);
  AddContainerWithCodecs("service/webos-dvr", webos_codecs);
#endif
// TV/Signage Custom
#if defined(USE_TV_MEDIA) || defined(USE_SIGNAGE_MEDIA)
  AddContainerWithCodecs("service/webos-external", webos_codecs);
  AddContainerWithCodecs("service/webos-photo", webos_codecs);
