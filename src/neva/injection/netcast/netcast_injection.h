...
#ifndef NEVA_INJECTION_NETCAST_NETCAST_INJECTION_H_
#define NEVA_INJECTION_NETCAST_NETCAST_INJECTION_H_
...
class COMPONENT_EXPORT(INJECTION) NetCastWebAPI {
 public:
  static const char kInjectionName[];
  static void Install(blink::WebLocalFrame* frame);
  static void Uninstall(blink::WebLocalFrame* frame);
 private:
  static v8::MaybeLocal<v8::Object> CreateNetCastObject(
...
#endif  // NEVA_INJECTION_NETCAST_NETCAST_INJECTION_H_
