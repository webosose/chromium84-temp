...
extern const char kVSM[];
extern const char kDisplay[];
extern const char kAVBlock[];
extern const char kAudio[];
extern const char kBroadCast[];
extern const char kChannel[];
extern const char kExternalDevice[];
extern const char kDVR[];
extern const char kSound[];
extern const char kSubtitle[];
extern const char kDRM[];
extern const char kSettings[];
extern const char kPhotoRenderer[];
