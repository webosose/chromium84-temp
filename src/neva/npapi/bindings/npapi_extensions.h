...
#ifndef NEVA_NPAPI_BINDINGS_NPAPI_EXTENSIONS_H_
#define NEVA_NPAPI_BINDINGS_NPAPI_EXTENSIONS_H_
...
// DEPRECATED: this typedef is just for the NaCl code until they
// switch to NPNExtensions.
...
#endif  // NEVA_NPAPI_BINDINGS_NPAPI_EXTENSIONS_H_
