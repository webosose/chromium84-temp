...
#ifndef NEVA_NPAPI_BINDINGS_NPAPI_EXTENSIONS_PRIVATE_H_
#define NEVA_NPAPI_BINDINGS_NPAPI_EXTENSIONS_PRIVATE_H_
...
#endif  // NEVA_NPAPI_BINDINGS_NPAPI_EXTENSIONS_PRIVATE_H_
